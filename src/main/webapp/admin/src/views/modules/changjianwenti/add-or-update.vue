  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="问题名称" prop="wentimingcheng">
              <el-input v-model="ruleForm.wentimingcheng" 
                placeholder="问题名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="问题类型" prop="wentileixing">
          <el-input v-model="ruleForm.wentileixing" 
              placeholder="问题类型" clearable  :readonly="ro.wentileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="问题类型" prop="wentileixing">
              <el-input v-model="ruleForm.wentileixing" 
                placeholder="问题类型" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.wentitupian" label="问题图片" prop="wentitupian">
          <file-upload
          tip="点击上传问题图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wentitupian" label="问题图片" prop="wentitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wentitupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="问题内容" prop="wentineirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="问题内容"
                  v-model="ruleForm.wentineirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wentineirong" label="问题内容" prop="wentineirong">
                    <span>{{ruleForm.wentineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="解决方法" prop="jiejuefangfa">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiejuefangfa" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiejuefangfa" label="解决方法" prop="jiejuefangfa">
                    <span v-html="ruleForm.jiejuefangfa"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wentimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='wentileixing'){
            this.ruleForm.wentileixing = obj[o];
	    this.ro.wentileixing = true;
            continue;
          }
	            	            if(o=='wentitupian'){
	    ...
	    this.ro.wentitupian = true;
            continue;
	            	            ...
	            	            if(o=='wentineirong'){
            this.ruleForm.wentineirong = obj[o];
	    this.ro.wentineirong = true;
            continue;
          }
	            	            if(o=='jiejuefangfa'){
            this.ruleForm.jiejuefangfa = obj[o];
	    this.ro.jiejuefangfa = true;
            continue;
          }
	            	            if(o=='faburiqi'){
	...
	this.ruleForm.jiejuefangfa = this.ruleForm.jiejuefangfa.replace(reg,'../../../ssmg08o4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `changjianwenti/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.changjianwentiCrossAddOrUpdateFlag = false;
                  this.parent.search();
