  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.chushengriqi" label="出生日期" prop="chushengriqi">
              <el-input v-model="ruleForm.chushengriqi" 
                placeholder="出生日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="相声角色" prop="xiangshengjiaose">
          <el-select v-model="ruleForm.xiangshengjiaose" placeholder="请选择相声角色">
            <el-option
                v-for="(item,index) in xiangshengjiaoseOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="相声角色" prop="xiangshengjiaose">
	      <el-input v-model="ruleForm.xiangshengjiaose"
                placeholder="相声角色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="作品代表" prop="zuopindaibiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="作品代表"
                  v-model="ruleForm.zuopindaibiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuopindaibiao" label="作品代表" prop="zuopindaibiao">
                    <span>{{ruleForm.zuopindaibiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="人物介绍" prop="renwujieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.renwujieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.renwujieshao" label="人物介绍" prop="renwujieshao">
                    <span v-html="ruleForm.renwujieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	renwujieshao : false,
            ...
            ruleForm: {
                  ...
                  xiangshengjiaose: [
                            { required: true, message: '相声角色不能为空', trigger: 'blur' },
                                    	                                                              ],
                  zuopindaibiao: [
                                    	                                                              ],
                  renwujieshao: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chushengriqi = true;
            continue;
	            	            ...
	            	            if(o=='xiangshengjiaose'){
            this.ruleForm.xiangshengjiaose = obj[o];
	    this.ro.xiangshengjiaose = true;
            continue;
          }
	            	            if(o=='zuopindaibiao'){
            this.ruleForm.zuopindaibiao = obj[o];
	    this.ro.zuopindaibiao = true;
            continue;
          }
	            	            if(o=='renwujieshao'){
            this.ruleForm.renwujieshao = obj[o];
	    this.ro.renwujieshao = true;
            continue;
          }
	                    }
                                                                                                              }
	...
	this.ruleForm.renwujieshao = this.ruleForm.renwujieshao.replace(reg,'../../../ssmg08o4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yanyuanjianjie/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yanyuanjianjieCrossAddOrUpdateFlag = false;
                  this.parent.search();
